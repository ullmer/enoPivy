#Clock code migrated and extended from PyGame Zero for Pivy integration
# https://github.com/lordmauve/pgzero/blob/master/pgzero/clock.py
# GNU LGPL 3.0 : https://github.com/lordmauve/pgzero/blob/master/COPYING
...
# [Presently, below is identical to PyGame Zero clock.py source, following consultation with
#  lordmauve re animation.py]
